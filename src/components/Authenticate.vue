<template>
  <div class="bg-black h-screen w-screen p-10 py-10 med">
    <div class="flex flex-row space-x-2">
      <div class="text-orange-500 text-4xl style">
        <img src="@/assets/images/logo.jpeg" alt="" class="h-[50px]" />
      </div>
    ...
    <div class="mt-[60px] text-white flex flex-row justify-between wod">
      <div>
